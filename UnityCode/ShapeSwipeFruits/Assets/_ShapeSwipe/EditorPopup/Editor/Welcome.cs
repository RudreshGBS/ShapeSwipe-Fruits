...
namespace AppAdvisory.ShapeSwipe
{
	...
	public class Welcome : EditorWindow 
	{
		...
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		private const string ONLINE_DOC_URL = "https://docs.google.com/document/d/1PjsKMBT2t68LM7gSJBqieloMgor-1xdn-82RIsBnygg/edit?usp=sharing";
		private const string RATEUS_URL = "\thttp://u3d.as/wFo";

		private const string NAME_OF_THE_GAME = "Shape Swipe";
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
